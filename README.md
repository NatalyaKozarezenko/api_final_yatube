...
Проект Yatube позволяет делиться пользователям новостями, собятиями. Каждый желающий может вести свой блог и получать комментариина сообщения. Есть возможность подписаться, если чьи-то посты наиболее интересны.
...
### Примеры запросов:
1. Пример POST-запроса для пользователя Яндекс Практикум:
POST .../api/v1/posts/
